# Contributing to `@semore/ucp-adapter`
...
3. Add or update Vitest tests. Keep coverage of `advertiseCapability` and
   `buildCapabilityDocument` paths.
...
<semore.hq@gmail.com> with the subject line `SECURITY: ucp-adapter`.
